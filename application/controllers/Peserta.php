...
class Peserta extends CI_Controller
{
    ...
    {  	
	    ...
	    if ($row) {
	        $data = array(
				...
				'asal_sekolah_dasar' => $row->asal_sekolah_dasar,
				'no_un' => $row->no_un,
    ...
    public function create()
    {
	    $data = array(
			...
			'ukuran_seragam' => set_value('ukuran_seragam'),
			'asal_sekolah_dasar' => set_value('asal_sekolah_dasar'),
			'nama_sekolah_dasar' => set_value('nama_sekolah_dasar'),
		);
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			$user_input =  $this->ion_auth->user()->row();
			$user_fullname = ($user_input->first_name ?? null) . " " . ($user_input->last_name ?? null);
            ...
            $data = array(
				...
				'asal_sekolah_dasar' => $this->input->post('asal_sekolah_dasar',TRUE),
				'nama_sekolah_dasar' => $this->input->post('nama_sekolah_dasar',TRUE),
			...
			if ($cekno) {
	            ...
	            $insert_id = $this->Peserta_model->insert($data);
	            $this->session->set_flashdata('message', 'Data Berhasil ditambahkan');
            	helper_log("add", "Menambah data peserta ".$data['nama_peserta']); 	            
	            redirect(site_url("peserta/read/{$insert_id}?upload-berkas"));
	        } 
	    }
	}
    ...
    public function update($id)
    {
	    ...
	    if ($row) {
	        $data = array(
				...
				'ukuran_seragam' => set_value('ukuran_seragam', $row->ukuran_seragam),
				'asal_sekolah_dasar' => set_value('asal_sekolah_dasar', $row->asal_sekolah_dasar),
				'nama_sekolah_dasar' => set_value('nama_sekolah_dasar', $row->nama_sekolah_dasar),
			);
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			redirect(site_url("peserta/read/{$id_peserta}?upload-berkas"));
        }
    }
    ...
    public function excel()
    {
		...
		xlsWriteLabel($tablehead, $kolomhead++, "Ukuran Seragam");
		...
		xlsWriteLabel($tablehead, $kolomhead++, "Asal Sekolah Dasar");
		...
		foreach ($this->Peserta_model->get_all() as $data) {
			...
			xlsWriteLabel($tablebody, $kolombody++, $data->ukuran_seragam);
			...
			xlsWriteLabel($tablebody, $kolombody++, $data->asal_sekolah_dasar);
	...
	function upload_berkas($id)
    {
		...
		redirect(site_url("peserta/read/{$id_peserta}"));
