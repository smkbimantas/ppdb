        ...
        <div class="box box-primary">
            ...
            <style>
              .select2{width:100% !important};
                ...
                <?php if ($berkas_limit):?>
                    <?php foreach ($berkas_limit as $value): ?>
                    <?php endforeach;?>
                        <form action="<?php echo $action; ?>" method="post">                
                            <div class="box-header <?= $this->config->item('header')?>">
                                <h3 class="box-title">Data Status Peserta a/n <?php echo $nama_peserta ?></h3>              
                            </div><br>
                ...
                <?php else:?>
                    <div style="width:80%;margin-left:auto;margin-right:auto;text-align:center;">
                        <h3 class="text-center text-red">Berkas peserta didik belum diupload. <br/>Untuk verifikasi pendaftaran peserta didik harus upload berkas terlebih dulu!</h3>
                        <a href ="<?php echo site_url("peserta/read/{$id_peserta}?upload-berkas"); ?>" class="btn btn-danger">Kembali</a>
                    </div>
                <?php endif;?>
