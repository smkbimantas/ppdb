...
<!-- 	<?php if ($formulir->no_kip=='Ya'){ ?>			
	...
	<?php } ?>
		<tr> 	  
		    ...
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->ukuran_seragam ?? null ?></td>
		</tr>
		<tr> 		 
	...
	<?php } ?>
		...
		<tr>		    
		    ...
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->nama_sekolah_dasar ?? null ?></td>
		</tr>
	...
	<?php } ?>
		...
		<tr>		 
		    <td>Referensi</td>
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->referensi ?? null ?></td>
		</tr>
...
<?php } ?>
 	...
 	<table>
		...
		<tr>	
			...
			<?php if($peserta->created_by ?? null):?>
		   		<td>Petugas Pendaftar<br><br><br><br><br> <?php echo $peserta->created_by ?></td>
			<?php else:?>
