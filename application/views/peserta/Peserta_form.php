...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="box box-primary">
            ...
            <form data-parsley-validate action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    <label for="varchar">Referensi</label>
                    <input type="text" class="form-control" name="referensi" id="referensi" placeholder="Referensi" value="<?php echo $referensi ?? null; ?>"/>
                </div>
                
                <div class="row">
                    <!-- data siswa /registrasi -->
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-maxlength="10" data-parsley-minlength="10" data-parsley-type="digits" type="text" class="form-control" name="nisn" id="nisn" placeholder="NISN" value="<?php echo $nisn; ?>" required />
                        </div>
                        <?php } ?>
                        <?php if ($formulir->nik=='Ya'){ ?>
                        <div class="form-group">
                            <label for="varchar">NIK <?php echo form_error('nik') ?></label>
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="text" class="form-control" name="nik" id="nik" placeholder="NIK" value="<?php echo $nik; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="hidden" class="form-control" name="nik" id="nik" />
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="rt" id="rt" placeholder="RT" value="<?php echo $rt; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="rw" id="rw" placeholder="RW" value="<?php echo $rw; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-maxlength="5" data-parsley-minlength="5" data-parsley-type="digits" type="text" class="form-control" name="kode_pos" id="kode_pos" placeholder="Kode Pos" value="<?php echo $kode_pos; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="5" data-parsley-minlength="5" data-parsley-type="digits" type="hidden" class="form-control" name="kode_pos" id="kode_pos" />
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="anak_ke" id="anak_ke" placeholder="Anak Ke" value="<?php echo $anak_ke; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-type="digits" type="hidden" class="form-control" name="anak_ke" id="anak_ke" />
                        <?php } ?>                          
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" data-parsley-maxlength="6" data-parsley-minlength="6" class="form-control" name="no_kip" id="no_kip" placeholder="No KIP" value="<?php echo $no_kip; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="6" data-parsley-minlength="6" type="hidden" class="form-control" name="no_kip" id="no_kip" />
                        <?php } ?>                          
                        ...
                        <div class="form-group">
                            <label for="ukuran_seragam">Asal Sekolah Dasar<span style="color:red;">*</span></label>
                            <select type="text" class="custom-select form-control" name="asal_sekolah_dasar" id="asal_sekolah_dasar" required/>
                                <option disabled selected value> -- Pilih asal sekolah dasar -- </option>    
                                <option <?php if ($asal_sekolah_dasar == 'SD'){ echo 'selected';} ?> value="SD">SD</option>
                                <option <?php if ($asal_sekolah_dasar == 'MI'){ echo 'selected';} ?> value="MI">MI</option>
                            </select>
                        </div>
                        
                        <div class="form-group">
                            <label for="varchar">Nama Sekolah Dasar <span style="color:red;">*</span> <?php echo form_error('nama_sekolah_dasar') ?></label>
                            <input type="text" class="form-control" name="nama_sekolah_dasar" id="nama_sekolah_dasar" placeholder="Nama Sekolah Dasar" value="<?php echo $nama_sekolah_dasar; ?>" required />
                        </div>
                    </div>
                    <!-- end data siswa -->

                    <!-- data orangtua/wali, kontak, periodik -->
                    <div class="col-md-6">
                        <div class="box-header <?= $this->config->item('header')?>">
                        ...
                        <div class="form-group">
                            ...
                            <input  data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="text" class="form-control" name="nik_ayah" id="nik_ayah" placeholder="NIK Ayah" value="<?php echo $nik_ayah; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="hidden" class="form-control" name="nik_ayah" id="nik_ayah" />
                        <?php } ?>                          
                        <?php if ($formulir->tahun_lahir_ayah=='Ya'){ ?>
                        <div class="form-group">
                            <label for="varchar">Tahun Lahir Ayah <?php echo form_error('tahun_lahir_ayah') ?></label>
                            <input data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="text" class="form-control" name="tahun_lahir_ayah" id="tahun_lahir_ayah" placeholder="Tahun Lahir Ayah" value="<?php echo $tahun_lahir_ayah; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="hidden" class="form-control" name="tahun_lahir_ayah" id="tahun_lahir_ayah" />
                        <?php } ?>                          
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="text" class="form-control" name="nik_ibu" id="nik_ibu" placeholder="NIK Ibu" value="<?php echo $nik_ibu; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="hidden" class="form-control" name="nik_ibu" id="nik_ibu" />
                        <?php } ?>                          
                        <?php if ($formulir->tahun_lahir_ibu=='Ya'){ ?>
                        <div class="form-group">
                            <label for="varchar">Tahun Lahir Ibu <?php echo form_error('tahun_lahir_ibu') ?></label>
                            <input  data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="text" class="form-control" name="tahun_lahir_ibu" id="tahun_lahir_ibu" placeholder="Tahun Lahir Ibu" value="<?php echo $tahun_lahir_ibu; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="hidden" class="form-control" name="tahun_lahir_ibu" id="tahun_lahir_ibu" />
                        <?php } ?>                          
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-maxlength="16" data-parsley-minlength="16" data-parsley-type="digits" type="text" class="form-control" name="nik_wali" id="nik_wali" placeholder="NIK Wali" value="<?php echo $nik_wali; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input  data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="text" class="form-control" name="tahun_lahir_wali" id="tahun_lahir_wali" placeholder="Tahun Lahir Wali" value="<?php echo $tahun_lahir_wali; ?>" />
                        </div>
                        <?php } else { ?>
                            <input  data-parsley-maxlength="4" data-parsley-minlength="4" data-parsley-type="digits" type="hidden" class="form-control" name="tahun_lahir_wali" id="tahun_lahir_wali" />
                        <?php } ?>                          
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="no_telepon_rumah" id="no_telepon_rumah" placeholder="No Telepon Rumah" value="<?php echo $no_telepon_rumah; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="nomor_hp" id="nomor_hp" placeholder="No Handphone" value="<?php echo $nomor_hp; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-type="digits" type="hidden" class="form-control" name="nomor_hp" id="nomor_hp" />
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="tinggi_badan" id="tinggi_badan" placeholder="Tinggi Badan" value="<?php echo $tinggi_badan; ?>" />
                        </div>
                        <?php } else { ?>
                            <input data-parsley-type="digits" type="hidden" class="form-control" name="tinggi_badan" id="tinggi_badan" />
                        <?php } ?>                          
                        <?php if ($formulir->berat_badan=='Ya'){ ?>
                        <div class="form-group">
                            <label for="varchar">Berat Badan <?php echo form_error('berat_badan') ?></label>
                            <input data-parsley-type="digits" type="text" class="form-control" name="berat_badan" id="berat_badan" placeholder="Berat Badan" value="<?php echo $berat_badan; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input data-parsley-type="digits" type="text" class="form-control" name="jumlah_saudara_kandung" id="jumlah_saudara_kandung" placeholder="Jumlah Saudara Kandung" value="<?php echo $jumlah_saudara_kandung; ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="form-group">
                            <label for="ukuran_seragam">Ukuran Seragam<span style="color:red;">*</span></label>
                            <select type="text" class="custom-select form-control" name="ukuran_seragam" id="ukuran_seragam" required/>
                                <option <?php if (!$ukuran_seragam){ echo 'selected';} ?>> -- Pilih ukuran seragam -- </option>    
                                <option <?php if ($ukuran_seragam == 'S'){ echo 'selected';} ?> value="S">Small (S)</option>
                                <option <?php if ($ukuran_seragam == 'M'){ echo 'selected';} ?> value="M">Medium (M)</option>
                                <option <?php if ($ukuran_seragam == 'L'){ echo 'selected';} ?> value="L">Large (L)</option>
                                <option <?php if ($ukuran_seragam == 'XL'){ echo 'selected';} ?> value="XL">Extra Large (XL)</option>
                                <option <?php if ($ukuran_seragam == 'XXL'){ echo 'selected';} ?> value="XXL">Double Extra Large (XXL)</option>
                            </select>
                        </div>
                ...
                <?php if ($button=="Tambah") { ?>    Data Statu
                ...
                <?php } else { ?>
                    <select type="text" class="form-control" name="status" id="status" placeholder="Status" value="" />
                        <option value="<?php echo $peserta->status ?? "Belum diverifikasi"; ?>"><?php echo $peserta->status ?? "Belum diverifikasi"; ?></option>
                        <option value="Belum diverifikasi">Belum diverifikasi</option>
                        <option value="Sudah diverifikasi">Sudah diverifikasi</option>
                        <option value="Berkas Kurang">Berkas tidak lengkap</option>
                    </select>                    
