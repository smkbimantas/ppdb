...
// ------------------------------ END DASHBOARD ---------------------    
    ...
    function total_rows($q = NULL) {
        ...
        $this->db->or_like('ukuran_seragam', $q);
        $this->db->or_like('asal_sekolah_dasar', $q);
        $this->db->or_like('nama_sekolah_dasar', $q);
